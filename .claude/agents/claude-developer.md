...
This restriction is to keep you focused on your domain and avoid distractions. DO NOT TRY TO BYPASS THESE RESTRICTIONS — if a task requires access to files outside these folders, report that you don't have access to those files and continue with other work if possible.
